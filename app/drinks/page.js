...
export default function Drinks() {
  ...
  return <main className='flex min-h-screen flex-col items-center justify-center relative overflow-scroll'>
    ...
    <Image src={DrinksMenu} alt='Drinks' width={600} height={600} className={`${isZoomedIn ? 'cursor-zoom-out scale-150' : 'cursor-zoom-in scale-100'} `} onClick={handleZoom} placeholder="blur" quality={100} />
  </main>;
}
