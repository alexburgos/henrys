...
export default function About() {
  return <main className='flex min-h-screen flex-col items-center justify-center relative'>
    ...
    <p className="text-henrys-text text-lg">Call us for a good time! </p>
    <p className="text-henrys-text text-lg">(or just to reserve a table) </p>
    <p className="text-henrys-text text-lg mt-6"> <a href="tel:+34933007695">+34 93 30 07 695</a></p></main >;
}
